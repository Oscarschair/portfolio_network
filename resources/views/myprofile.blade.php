            ...
            <div class="OSCSS-content-box">
                <div class="OSCSS-content-box-inner">
                    <dl>
                        ...
                        <dd>
                            <form action="{{ route('editProfile') }}" id="ProfileModForm_icon" method="post"
                    ...
                    <form action="{{ route('editProfile') }}" id="ProfileModForm_name" method="post"
                        ...
                        <dl>
                            ...
                            <dt>ユーザー名：</dt>
                            <dd>
                                <input name="name" value="{{ $user->name }}" class="c-text-input" type="text"
                                    id="UserName" required="required" onKeyup="this.value=this.value.replace('@','')">
                    ...
                    <dl>
                        <dt>自己紹介：</dt>
                        <dd>
                            <form action="{{ route('editProfile') }}" id="ProfileModForm_description" method="post"
                                accept-charset="utf-8">
                                @csrf
                                <div style="display:none;">
                                    <input type="hidden" name="updateMethod" value="editDescription">
                                </div>
                                <textarea rows="5" cols="60" name="description" type="text" id="userDescription" required="required"
                                    placeholder="自己紹介" maxlength="5000">{{ $user->description }}</textarea>
                        ...
                        @foreach ($portfolios as $portfolio)
                                ...
                                <div class="OSCSS-profile-portfolio-pic">
                                    <div class="OSCSS-profile-portfolio-pic-inner">
                                        @if ($portfolio->icon_path == null)
                                            <img src="{{ asset('img/defaultPortfolioIcon.png') }}" width="300"
                                                height="200" />
                                        @else
                                            <img src="{{ asset('portfolioimages/' . $portfolio->icon_path) }}" width="150"
                                                height="150" />
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="OSCSS-profile-portfolio-right">
                                <table class="OSCSS-portfolio-table">
                                    ...
                                    <tr>
                                        <td>詳細内容</td>
                                        <td class="OSCSS-profile-portfolio-desc">{{ $portfolio->description }}</td>
                                    </tr>
                                    <tr>
                                        <td>URL</td>
                                        <td>{{ $portfolio->url }}</td>
                                    ...
                                    <tr>
                                        <td>タイプ</td>
                                        <td>{{ $portfolioTypes[$portfolio->type] }}</td>
                                    </tr>
                                    <tr>
                                        <td>所有者認証</td>
                                ...
                                <form action="{{ route('editProfile') }}" id="ProfileModForm_deletePortfolio"
                                    method="post" accept-charset="utf-8">
                                    @csrf
                                    <a href="/portfolio/mod/{{ $portfolio->id }}"
                                        class="btn btn-primary OSCSS-btn-portfolio">認証．編集する</a>
                                    <div style="display:none;">
                                        <input type="hidden" name="updateMethod" value="deletePortfolio">
                                        <input type="hidden" name="portfolioID" value="{{ $portfolio->id }}">
                                    </div>
                                    <input name="submit" class="btn btn-secondary OSCSS-btn50" type="submit"
                                        value="削除する">
                                </form>
                            </div>
                            <hr>
                    ...
                    <div class="OSCSS-profile-portfolio-new">
                        <form action="{{ route('editProfile') }}" id="ProfileModForm_addPortfolio" method="post"
                            ...
                            <dl>
                                ...
                                <dt>サイトURL：</dt>
                                <dd>
                                    <input name="newURL" value="https://" class="c-text-input" pattern="https?://.*"
                                        type="text" id="newURL" required="required">
                                    <input name="submit" class="btn btn-primary OSCSS-btn50" type="submit"
                                        value="サイトを追加する">
                                </dd>
                            </dl>
                        </form>
