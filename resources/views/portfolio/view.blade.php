      ...
      <div class="OSCSS-content-box">
        ...
        <div class="OSCSS-social-share">
          ...
          <div class="OSCSS-social-button">
            ...
            <div class="fb-share-button" data-href="https://portfolio-network.oscarchair.jp/portfolio/{{ $portfolio->id }}" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">シェア</a></div>
          </div>
        </div>
      </div>
      @else
